    ...
    return(
        <div className='flex flex-col justify-center m-auto sm:mb-0q exit h-auto mt-auto text-white py-4 px-10 sm:py-10 w-11/12 lg:w-1/2'>
            <div className='mb-20 pb-10 shadow-sm rounded-xl bg-gray-900 w-full'>
                <h2 className='flex justify-center bg-yellow-500 rounded-t-xl text-xl text-black sm:text-5xl py-2'>AboutMe</h2>
                    
                <div className='flex flex-col justify-center px-2'>
                    <img className='mx-auto flex justify-center my-5 w-60 rounded-full border-8 shadow-sm border-yellow-500' src={profilePic} alt='Profile picture'/>
