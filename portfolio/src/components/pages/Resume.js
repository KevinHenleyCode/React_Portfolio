    ...
    return(
         <div className='flex flex-col justify-center m-auto h-auto mt-auto py-4 px-10 sm:py-10 w-11/12 lg:w-1/2'>
            <div className='mb-20 pb-10 shadow-sm rounded-xl bg-gray-900'>
                <h2 className='flex justify-center bg-green-500 rounded-t-xl text-xl sm:text-5xl py-2'>Resume</h2>
                ...
                <div className='flex flex-col justify-center m-auto rounded-3xl p-2 border-4 border-green-500 bg-white w-24 hover:bg-green-200'>
