    ...
    return(
        <div className='flex flex-col justify-center rounded-xl m-auto h-auto mt-auto mt-20 py-4 px-10 sm:py-10 w-11/12 lg:w-1/2'>
            <div className='mb-20 pb-10 shadow-sm rounded-xl bg-gray-900'>
                <h2 className='flex justify-center bg-yellow-500 rounded-t-xl text-xl sm:text-5xl py-2'>Portfolio</h2>
                
                        <div className='flex items-center flex-col mx-4'>

                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'Scissors Palace'/></h3>
                            ...
                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'Ducking Awesome Soundboard'/></h3>
                                <img className='mb-2' src={BestWebsite} alt="Website picture"/>
                                <a className="flex justify-start mb-2 underline text-green-200 hover:text-red-500" href="https://kevinhenleycode.github.io/Ducking-Awesome-Soundboard/">Site</a>
                            ...
                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'Password Generator V2'/></h3>
                            ...
                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'README Generator'/></h3>
                            ...
                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'Ecommerce Backend'/></h3>
                            ...
                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'Coding Quiz'/></h3>
                            ...
                            <div className="flex flex-col justify-center rounded-xl bg-black my-4 mx-2 border-4 shadow-sm border-yellow-500 p-2 w-full md:h-full">
                                <h3 className="flex justify-center mb-2 text-yellow-500 text-2xl"><Project title = 'Aggretsukos Karaoke'/></h3>
