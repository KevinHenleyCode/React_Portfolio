...
function Footer() {
    return(
        <footer className='bg-black mt-auto py-4  sm:py-4'>
        <ul className='flex flex-col items-center sm:flex-row sm:justify-around'>
            ...
            <li className='mb-4'><a href="https://stackoverflow.com/users/16102427/kevinhenleycode?tab=profile"><img className='w-6 sm:w-10' src={StackOverflow} alt="img" /></a></li>
        </ul>
        </footer>
    )
}
